...
typedef enum
{
    ...
    APPEERAM_STATE_ACTIVATE_BIT_ASE,
    APPEERAM_STATE_WAIT_WRITE_BIT_ASE,        
    APPEERAM_STATE_WRITE_INITIAL_ADDRESS_READ,    
    APPEERAM_STATE_READ_ARRAY_EERAM,   
    APPEERAM_STATE_INITIALIZE_CRC_READ,    
    APPEERAM_STATE_WAIT_CRC_READ, 
    APPEERAM_STATE_ANALYZE_DATA_READ_FROM_EERAM,
    APPEERAM_STATE_DEFAULT_VALUES,
    APPEERAM_STATE_INITIALIZE_CRC_WRITE, 
    APPEERAM_STATE_WAIT_CRC_WRITE, 
    APPERRAM_STATE_STORE_BUFFER_EERAM,    
    APPEERAM_ESTADO_ESPERAR_TRANSFERENCIA_ARREGLO_EERAM,        
    APPEERAM_STATE_IDLE,        
